      ...
      <div className='container'>
        ...
        <MainContainer style={{width: "75%"}}>
          <ChatContainer >
            ...
            typingIndicator={typing ? <TypingIndicator content="SebasAI esta escribiendo..." /> : null style={{ margin-bottom: "20px"}}}
            >
              {
            ...
            <MessageInput placeholder='Mensaje' onSend={handleSend} style={{ position: "fixed", bottom: "20px", width:"70%"}}/>
          </ChatContainer>
        </MainContainer>
      </div>
    </div>
